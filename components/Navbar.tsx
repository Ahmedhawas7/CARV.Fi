        ...
        <div className="flex items-center gap-3 sm:gap-6">
          ...
          {!user.isPremium && onOpenPremium && (
            <button
              ...
              className="mr-2 px-4 py-1.5 bg-gradient-to-r from-yellow-600/20 to-orange-600/20 border border-yellow-500/50 rounded-full text-yellow-500 text-[10px] font-black uppercase tracking-widest hover:bg-yellow-500/20 transition-all animate-pulse"
            >
              Get Premium 👑
            </button>
          )}
